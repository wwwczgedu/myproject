<template>
    <div class="circle" @click.stop="circleUp">
            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-md-6 col-xs-offset-2 col-md-offset-3">
                    ...
                    <div class="inner">
                        ...
                        <div class="buttons">
                            <div :class="'btn'+index" v-for="(item,index) in circleData.circleBtnImg" :style="{backgroundImage: 'url(./src/assets/images/button/'+item.url+')'}">
